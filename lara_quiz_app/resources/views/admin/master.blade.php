...
<div id="wrapper">
    ...
    <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="index.html">Laravel Quize app</a>
        </div>
        <!-- /.navbar-header -->
        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav navbar-collapse">
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a href="{{ route('question.index') }}"><i class="fa fa-bar-chart-o fa-fw"></i>Make Questions</a>
                    </li>
                    <li>
                        <a href="{{ route('quiz') }}"><i class="fa fa-wrench fa-fw"></i>Take Quiz<span class="fa arrow"></span></a>
                    </li>
{{--                    <li>--}}
